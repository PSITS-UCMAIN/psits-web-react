...
export const deletedStudent =
  async (): Promise<DeletedStudentsResponse | void> => {
    try {
...
export const membershipRequest =
  async (): Promise<MembershipRequestResponse | void> => {
    try {
      const response: AxiosResponse<MembershipRequestResponse> =
        await axios.get(`${backendConnection()}/api/admin/membership-request`, {
          headers: createHeaders(),
        });
      return response.data;
    } catch (error) {
...
export const merchCreated = async (): Promise<MerchandiseCount | void> => {
  try {
    const response: AxiosResponse<{ message: MerchandiseCount }> =
      await axios.get(`${backendConnection()}/api/admin/merchandise-created`, {
        headers: createHeaders(),
      });
    return response.data.message;
  } catch (error) {
...
export const membershipHistory =
  async (): Promise<MembershipHistoryResponse | void> => {
    try {
      const response: AxiosResponse<MembershipHistoryResponse> =
        await axios.get(`${backendConnection()}/api/admin/history`, {
          headers: createHeaders(),
        });
      return response.data;
    } catch (error) {
...
export const getStudentMembershipHistory = async (
  studentId: string
): Promise<MembershipHistoryData[] | void> => {
  try {
    const response: AxiosResponse<{ data: MembershipHistoryData[] }> =
      await axios.get(
